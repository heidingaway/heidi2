---
uri: https://gcxgce.sharepoint.com/teams/10001579/#measurement_collection
...
```mermaid
graph TD
  Measurement_Collection["Measurement Collection"]:::current-page-node
  area_hr_planning_reporting["area_hr_planning_reporting"]
  measurement_framework["measurement_framework"]
  Measurement_Collection-->|" subClassOf "|area_hr_planning_reporting
