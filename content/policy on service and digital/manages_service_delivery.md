---
uri: https://www.canada.ca/#manages_service_delivery
title: Manages service delivery
mermaid_layers: 3
entities:
...
```mermaid
graph TD
  Manages_service_delivery["Manages service delivery<br>+ label: Manages service delivery"]:::current-page-node
