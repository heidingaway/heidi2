...
```mermaid
graph TD
  Policy_on_Government_Security["Policy on Government Security<br>+ label: Policy on Government Security"]:::current-page-node
  ...
  Directive_on_the_Management_of_Projects_and_Programmes-->|" isReferencedBy "|doc_engaspx_12
  ...
  Policy_on_Government_Security-->|" isReferencedBy "|doc_engaspx
