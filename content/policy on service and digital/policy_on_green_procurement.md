...
```mermaid
graph TD
  Policy_on_Green_Procurement["Policy on Green Procurement<br>+ label: Policy on Green Procurement"]:::current-page-node
  ...
  Directive_on_Charging_and_Special_Financial_Authorities-->|" isReferencedBy "|doc_engaspx_11
