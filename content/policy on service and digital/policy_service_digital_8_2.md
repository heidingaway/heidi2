...
```mermaid
graph TD
  Related_policy_instruments["Related policy instruments<br>+ label: Related policy instruments"]:::current-page-node
  ...
  Foundation_Framework_for_Treasury_Board_Policies-->|" isReferencedBy "|doc_engaspx_1
  ...
  Policy_on_Green_Procurement-->|" isReferencedBy "|doc_engaspx
