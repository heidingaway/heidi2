---
uri: https://www.canada.ca/#financial_administration_act
...
```mermaid
graph TD
  Financial_Administration_Act["Financial Administration Act<br>+ label: Financial Administration Act"]:::current-page-node
  f_11["f-11"]
