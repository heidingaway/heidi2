---
uri: https://www.canada.ca/#service_digital_functions
title: Service and digital functions
mermaid_layers: 3
entities:
...
```mermaid
graph TD
  Service_and_digital_functions["Service and digital functions<br>+ label: Service and digital functions"]:::current-page-node
