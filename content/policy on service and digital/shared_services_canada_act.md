---
uri: https://www.canada.ca/#shared_services_canada_act
...
```mermaid
graph TD
  Shared_Services_Canada_Act["Shared Services Canada Act<br>+ label: Shared Services Canada Act"]:::current-page-node
  s_89["s-8.9"]
