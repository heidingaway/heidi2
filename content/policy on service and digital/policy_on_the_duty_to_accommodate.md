...
title: Policy on the Duty to Accommodate Persons with Disabilities in the Federal
  Public Service
mermaid_layers: 3
entities:
...
```mermaid
graph TD
  Policy_on_the_Duty_to_Accommodate_Persons_with_Disabilities_in_the_Federal_Public_Service["Policy on the Duty to Accommodate Persons with Disabilities in the Federal Public Service<br>+ label: Policy on the Duty to Accommodate Persons with Disabilities in the Federal Public Service"]:::current-page-node
