---
uri: https://www.canada.ca/#access_to_information_act
...
```mermaid
graph TD
  Access_to_Information_Act["Access to Information Act<br>+ label: Access to Information Act"]:::current-page-node
  a_1["a-1"]
