...
```mermaid
graph TD
  Directive_on_Charging_and_Special_Financial_Authorities["Directive on Charging and Special Financial Authorities<br>+ label: Directive on Charging and Special Financial Authorities"]:::current-page-node
  ...
  Policy_on_Transfer_Payments-->|" isReferencedBy "|doc_engaspx_7
  ...
  Policy_on_Communications_and_Federal_Identity-->|" isReferencedBy "|doc_engaspx_6
  Values_and_Ethics_Code_for_the_Public_Sector-->|" isReferencedBy "|doc_engaspx_4
  Directive_on_the_Management_of_Projects_and_Programmes-->|" isReferencedBy "|doc_engaspx_8
  ...
  Directive_on_Charging_and_Special_Financial_Authorities-->|" isReferencedBy "|doc_engaspx
