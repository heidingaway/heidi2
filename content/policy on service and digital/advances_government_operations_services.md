---
uri: https://www.canada.ca/#advances_government_operations_services
title: Advances government operations and services
mermaid_layers: 3
entities:
...
```mermaid
graph TD
  Advances_government_operations_and_services["Advances government operations and services<br>+ label: Advances government operations and services"]:::current-page-node
